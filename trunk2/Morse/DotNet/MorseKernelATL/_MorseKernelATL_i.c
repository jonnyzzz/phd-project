...
MIDL_DEFINE_GUID(IID, IID_AbstractComputationEvent,0xA05EF93D,0x10B9,0x41ED,0xAF,0x38,0xBC,0x01,0x93,0xFD,0xFF,0x96);


MIDL_DEFINE_GUID(IID, IID_AbstractEvent,0x169609CE,0x174B,0x42E4,0x88,0x83,0xCB,0x72,0x16,0x08,0x89,0x69);
...
MIDL_DEFINE_GUID(IID, IID_IProjectiveBundleEvents,0xA9EBC232,0xAB43,0x43EA,0x89,0xE6,0x67,0x10,0xFD,0xD3,0x53,0x42);


MIDL_DEFINE_GUID(IID, IID_ISymbolicImage,0xFA9817A1,0x3666,0x41E7,0x8F,0xCF,0x09,0x85,0xA4,0x3D,0x5F,0xA6);


MIDL_DEFINE_GUID(IID, IID_ISymbolicImageEvents,0x4840FAA7,0x422A,0x4717,0x83,0x18,0xE3,0xDC,0x82,0x59,0x9C,0xBC);
