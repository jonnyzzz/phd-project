...
namespace EugenePetrenko.Gui2.Application.Forms
{
  ...
  public class SystemFunctionAnalisys : Form
  {
    ...
    public static void ShowAnalisys()
    {
      ...
      {
        Runner.Runner.Instance.Document.AnalisysForm =
          new SystemFunctionAnalisys(document.KernelDocument.Function.EvaluateFunction);
      }
    ...
    protected SystemFunctionAnalisys(IEvaluateFunction function)
    {
      ...
      SizeChanged += new EventHandler(OnRedesign);
      Resize += new EventHandler(OnRedesign);
