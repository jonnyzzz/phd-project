...
namespace gui2.Forms
{
	...
	/// </summary>
	public class ParametersSelector : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.GroupBox parameterCaptionBox;
		private System.Windows.Forms.Panel panelParametersContainer;
		/// <summary>
		...
		private ParametersControl CurrentParameterControl
		{
			get
			{
				return controls[parameterIndex];
			}
		}
