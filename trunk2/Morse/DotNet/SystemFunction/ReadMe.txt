========================================================================
    STATIC LIBRARY : SystemFunction Project Overview
========================================================================

AppWizard has created this SystemFunction library project for you. 
This file contains a summary of what you will find in each of the files that
make up your SystemFunction application.


SystemFunction.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named SystemFunction.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "SystemFunction.rc" and a "SystemFunction.h" that 
