========================================================================
    STATIC LIBRARY : graph_simplex Project Overview
========================================================================

AppWizard has created this graph_simplex library project for you. 
This file contains a summary of what you will find in each of the files that
make up your graph_simplex application.


graph_simplex.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named graph_simplex.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "graph_simplex.rc" and a "graph_simplex.h" that 
