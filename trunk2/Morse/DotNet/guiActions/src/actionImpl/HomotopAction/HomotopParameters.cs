...
namespace EugenePetrenko.Gui2.Actions.ActionImpl.HomotopAction
{
  ...
  public class HomotopParameters : ParametersControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.linkUpdate.LinkClicked +=
        new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkUpdate_LinkClicked);
      // 
      // labelLength
      // 
    ...
    private void PerformSearch()
    {
      ...
      try
      {
        MinimalLoopLocalizationAction action =
          Core.Instance.NextActionFactory.NextActionByName(node, typeof (IMinimalLoopLocalizationAction)) as
          MinimalLoopLocalizationAction;
