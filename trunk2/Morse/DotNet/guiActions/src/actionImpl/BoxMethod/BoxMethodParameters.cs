...
namespace EugenePetrenko.Gui2.Actions.ActionImpl
{
  ...
  public class BoxMethodParameters : ParametersControl
  {
    ...
    public BoxMethodParameters(int dimension, Function function)
    {
      ...
      data = new IntPlusGridData(ResourceManager.Strings.CellDivision, dimension);
    ...
    private void InitializeComponent()
    {
      ...
      this.exGrid.Size = new System.Drawing.Size(408, 323);
      ...
      this.groupUp.Size = new System.Drawing.Size(424, 352);
      this.groupUp.TabIndex = 1;
      this.groupUp.TabStop = false;
      this.groupUp.Text = "Parameters";
      // 
      // panelUp
      // 
      ...
      this.panelUp.Size = new System.Drawing.Size(418, 333);
