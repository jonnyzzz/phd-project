========================================================================
    STATIC LIBRARY : adaptiveCellImageBuilder Project Overview
========================================================================

AppWizard has created this adaptiveCellImageBuilder library project for you. 
This file contains a summary of what you will find in each of the files that
make up your adaptiveCellImageBuilder application.


adaptiveCellImageBuilder.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named adaptiveCellImageBuilder.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "adaptiveCellImageBuilder.rc" and a "adaptiveCellImageBuilder.h" that 
