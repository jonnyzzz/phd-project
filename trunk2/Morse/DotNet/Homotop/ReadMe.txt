========================================================================
    STATIC LIBRARY : Homotop Project Overview
========================================================================

AppWizard has created this Homotop library project for you. 
This file contains a summary of what you will find in each of the files that
make up your Homotop application.
...
StdAfx.h, StdAfx.cpp
    ...
    named Homotop.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "Homotop.rc" and a "Homotop.h" that 
