...
namespace guiControls.TextFields
{
	/// <summary>
	/// Summary description for CenteredTextBox.
	/// </summary>
	public class CenteredTextBox : System.Windows.Forms.UserControl
	{
		...
		public CenteredTextBox()
		{
			...
			textControl.BackColorChanged +=new System.EventHandler(textControl_BackColorChanged);
		}
		...
		private void CenteredTextBox_Resize(object sender, System.EventArgs e)
		{
		...
		private void textControl_BackColorChanged(object sender, System.EventArgs e)
		{
			this.BackColor = textControl.BackColor;
			panelUp.BackColor = textControl.BackColor;
			panelCenter.BackColor = textControl.BackColor;
