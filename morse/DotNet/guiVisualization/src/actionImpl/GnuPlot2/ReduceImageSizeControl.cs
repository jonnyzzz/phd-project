...
namespace EugenePetrenko.Gui2.Visualization.ActionImpl.GnuPlot2
{
  ...
  public class ReduceImageSizeControl : UserControl
  {
    ...
    private CheckBox checkBoxReduceBeforeShow;
    ...
    public bool Reduse
    {
      ...
      set
      {
        checkBoxReduceSize.Checked = value;
        checkBoxReduceSize_CheckedChanged(this, new EventArgs());
      }
    }
    ...
    protected override void OnSizeChanged(EventArgs e)
    {
      if (!isInsizeSizeChanged)
      {
        ...
        Size = new Size(Size.Width, groupBoxImageSize.Size.Height + DockPadding.Bottom + DockPadding.Top + 5);
    ...
    private void checkBoxReduceSize_CheckedChanged(object sender, EventArgs e)
    {
      ...
      checkBoxReduceBeforeShow.Enabled = checkBoxReduceSize.Checked;
      checkBoxReduceBeforeShow.Checked = checkBoxReduceBeforeShow.Checked && checkBoxReduceSize.Checked;
    }
  }
}