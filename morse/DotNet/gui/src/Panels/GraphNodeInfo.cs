...
namespace gui.Panels
{
	...
	/// </summary>
	public class GraphNodeInfo : UserControl
	{
		private NotedTextField spaceSize;
		private NotedTextField cellSize;
		private NotedTextField pointsPerAxis;
		private NotedTextField graphParameters;
		private Panel panelMargins;
