...
extern const MIDL_SERVER_INFO IGL3D_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IGL3D_ProxyInfo;
...
/* Object interface: IGL3D, ver. 0.0,
   GUID={0xB1D47447,0xE686,0x41A7,{0x9A,0x02,0x6B,0xC3,0xCC,0xFF,0x02,0x69}} */

#pragma code_seg(".orpc")
static const unsigned short IGL3D_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IGL3D_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IGL3D_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IGL3D_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IGL3DProxyVtbl = 
{
    0,
    &IID_IGL3D,
    IUnknown_QueryInterface_Proxy,
...
static const PRPC_STUB_FUNCTION IGL3D_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IGL3DStubVtbl =
{
    &IID_IGL3D,
    &IGL3D_ServerInfo,
    7,
...
const CInterfaceProxyVtbl * __GLVisualization_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IGL3DProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * __GLVisualization_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IGL3DStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const __GLVisualization_InterfaceNamesList[] = 
{
    "IGL3D",
    "IComponentRegistrar",
    0
...
const IID *  __GLVisualization_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define __GLVisualization_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __GLVisualization, pIID, n)

int __stdcall __GLVisualization_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( __GLVisualization, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( __GLVisualization, 2, *pIndex )
    
}

const ExtendedProxyFileInfo _GLVisualization_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __GLVisualization_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __GLVisualization_StubVtblList,
    (const PCInterfaceName * ) & __GLVisualization_InterfaceNamesList,
    (const IID ** ) & __GLVisualization_BaseIIDList,
    & __GLVisualization_IID_Lookup, 
    2,
    2,
