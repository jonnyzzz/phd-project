...
namespace DSIS.CellImageBuilder.Tests
{
    ...
    where Q : IIntegerCoordinate
  {
    ...
    {
      get { return new PointMethodSettings {Points = 2, UseOverlapping = true, Overlap = 0.1  }; }
    }

    [Test]
    public void Test_01_y()
    {
    ...
    [Test]
    public void Test_08_Overlapped_x()
    {
      var ss = new MockSystemSpace(2, new double[] {0, 0}, new double[] {10, 10}, new long[] {10, 10});
      T ics = IntegerCoordinateSystemFactory.CreateCoordinateSystem<T, Q>(ss);
    ...
    [Test]
    public void Test_10_Overlapped_x()
    {
      var ss = new MockSystemSpace(2, new double[] {0, 0}, new double[] {10, 10}, new long[] {10, 10});
      T ics = IntegerCoordinateSystemFactory.CreateCoordinateSystem<T, Q>(ss);
    ...
    [Test]
    public void Test_11_Overlapped_X()
    {
      var ss = new MockSystemSpace(2, new double[] {0, 0}, new double[] {10, 10}, new long[] {10, 10});
      T ics = IntegerCoordinateSystemFactory.CreateCoordinateSystem<T, Q>(ss);
                   ...
                   delegate(double[] ins, double[] outs)
                     {
                       outs[0] = ins[0];
                       outs[1] = ins[1]*3;
                     }, new PointMethodSettings {Points = 2, UseOverlapping = true, Overlap = 0.1},
                   @"-------------------
                    ..........
                    .....xx.xx
                    .....xx.xx  
