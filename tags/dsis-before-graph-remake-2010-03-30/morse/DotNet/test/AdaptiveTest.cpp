...
AdaptiveTest::AdaptiveTest(void)  : TestBase("Adaptive", cout)
{
}

AdaptiveTest::~AdaptiveTest(void)
{
}


void AdaptiveTest::Test() {
	...
	SmartProcess process = new AdaptiveProvess(func, graph, factor2, precision, 0, &pinfo);
    process->start();
