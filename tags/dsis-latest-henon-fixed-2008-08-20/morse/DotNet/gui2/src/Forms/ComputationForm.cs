...
namespace EugenePetrenko.Gui2.Application.Forms
{
  ...
  public class ComputationForm : Form
  {
    ...
    private MenuItem menuItemFileSeparator;
    ...
    public ComputationForm()
    {
      ...
      documentDependentMenuItems = new MenuItem[]
        {
          menuFunctionShow,
          menuSystemAnalisys,
    ...
    private void opacityTick(object sender, EventArgs e)
    {
    ...
    private void menuSystemIterations_Click(object sender, EventArgs e)
    {
      if (Runner.Runner.Instance.Document != null)
      {
        FunctionIterations its =
          new FunctionIterations(Runner.Runner.Instance.Document.KernelDocument.Function.Iterations);
